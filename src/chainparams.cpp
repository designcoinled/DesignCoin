...
static Checkpoints::MapCheckpoints mapCheckpoints =
    ...
    (0, uint256("0x0000068b6de96ccbc840570c6c3375a6fca6f5422b1e4af9732f607597be0b0c"));
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1540288607, // * UNIX timestamp of last checkpoint block
...
public:
    CMainParams()
    {
        ...
        nDefaultPort = 21566;
        bnProofOfWorkLimit = ~uint256(0) >> 20; // DesignCoin starting difficulty is 1 / 2^12
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DesignCoin: 1 day
        nTargetSpacing = 1 * 60;  // DesignCoin: 1 minute
        nMaturity = 29;
         ...
         *   vMerkleTree: e0028e
         */
        const char* pszTimestamp = "SIGN - Design Coin was born";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1540288607;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 1437320;

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x0000068b6de96ccbc840570c6c3375a6fca6f5422b1e4af9732f607597be0b0c"));      //www.genesisblock.eu
        assert(genesis.hashMerkleRoot == uint256("0x995f9d9a8d8cbebde6fb81b733aafa7974063b9e7a81e7dae45aea8d3f6776c7"));
        
        vSeeds.push_back(CDNSSeedData("45.77.150.108", "45.77.150.108"));   
        vSeeds.push_back(CDNSSeedData("45.76.165.243", "45.76.165.243")); 
        ...
        strObfuscationPoolDummyAddress = "SeaR8jHDQ1s2kHVjysEoTQncVdUrNBuXtp";
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // DesignCoin: 1 day
        nTargetSpacing = 1 * 15;  // DesignCoin: 15 seconds
        nLastPOWBlock = 3000;
        nMaturity = 2;
        ...
        bnProofOfWorkLimit = ~uint256(0) >> 12;
  	    ...
  	    hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x665960719a92e64e226c5abe29848f5cdcb55178a65af42924120f69bd045625"));

        vFixedSeeds.clear();
        vSeeds.clear();

        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet designcoin addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet designcoin script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet designcoin BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet designcoin BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet designcoin BIP44 coin type is '1' (All coin's testnet default)
        ...
        strObfuscationPoolDummyAddress = "Sqax8jHDQ1s2kHVjysEoTQncVdUrNBuXtp";
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // DesignCoin: 1 day
        nTargetSpacing = 1 * 60;        // DesignCoin: 1 minutes
