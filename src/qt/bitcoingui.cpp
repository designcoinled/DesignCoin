                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("DesignCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a DesignCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and designcoin: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zSIGN"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About DesignCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about DesignCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for DesignCoin"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your DesignCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified DesignCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a DesignCoin: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the DesignCoin Core help message to get a list with possible DesignCoin command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("DesignCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to DesignCoin network", "", count));
}
...
{
    QString strTitle = tr("DesignCoin Core"); // default title
