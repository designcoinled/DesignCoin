...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("DesignCoin Core"),
     ...
     * override -datadir in the designcoin.conf file in the default data directory
     * (to be consistent with designcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
