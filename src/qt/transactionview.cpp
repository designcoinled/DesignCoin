                                                    ...
                                                    transactionView(0)
{
    ...
    typeWidget->addItem(tr("Received Sign from zSign"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    ...
    typeWidget->addItem(tr("Zerocoin Spend, Change in zSign"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zSign));
