...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("DesignCoin Core designcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  designcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded designcoin transaction") + "\n" +
                               "  designcoin-tx [options] -create [commands]   " + _("Create hex-encoded designcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded designcoin transaction
