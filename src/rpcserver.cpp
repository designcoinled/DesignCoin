...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop DesignCoin server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "DesignCoin server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DesignCoin features */
        {"designcoin", "masternode", &masternode, true, true, false},
        {"designcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"designcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"designcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"designcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"designcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"designcoin", "startmasternode", &startmasternode, true, true, false},
        {"designcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"designcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"designcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"designcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"designcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"designcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"designcoin", "mnbudget", &mnbudget, true, true, false},
        {"designcoin", "preparebudget", &preparebudget, true, true, false},
        {"designcoin", "submitbudget", &submitbudget, true, true, false},
        {"designcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"designcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"designcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"designcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"designcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"designcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"designcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"designcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"designcoin", "mnsync", &mnsync, true, true, false},
        {"designcoin", "spork", &spork, true, true, false},
        {"designcoin", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"designcoin", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use designcoind, or the -server option to designcoin-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> designcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21565/\n";
}
